  ...
  try {
    ...
    const r = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: FROM,
        to,
        subject: 'Detroit Dynamo - Email Verification Code',
        html: `<div style="background:#0A0E14;color:#F8FAFC;padding:40px;font-family:sans-serif;">
          ...
          <p>Enter this code in your Detroit Dynamo Settings page to confirm <strong>${to}</strong> as your coach contact address.</p>

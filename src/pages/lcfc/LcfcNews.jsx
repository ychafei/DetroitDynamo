          ...
          {featured && (
            <div className="grid lg:grid-cols-2 gap-0 rounded-2xl overflow-hidden border border-[#DDDAD2] bg-white shadow-[0_2px_20px_-8px_rgba(0,0,0,0.15)]">
              ...
              <div className="p-8 flex flex-col justify-center">
                <p className="font-oswald text-[11px] tracking-[0.25em] uppercase text-[#005DFF] mb-2">
                ...
                {featured.button_url && (
                  <a href={featured.button_url} className="inline-flex items-center gap-2 mt-5 text-[#005DFF] font-oswald tracking-widest uppercase text-sm hover:gap-3 transition-all">
              ...
              {rest.map((n) => (
                <div key={n.id} className="bg-white rounded-2xl border border-[#DDDAD2] overflow-hidden shadow-[0_2px_20px_-8px_rgba(0,0,0,0.15)] flex flex-col">
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    <p className="font-oswald text-[10px] tracking-[0.25em] uppercase text-[#005DFF] mb-2">{n.type || 'News'}</p>
                    ...
                    {n.button_url && (
                      <a href={n.button_url} className="inline-flex items-center gap-2 mt-4 text-[#005DFF] font-oswald tracking-widest uppercase text-xs hover:gap-3 transition-all">

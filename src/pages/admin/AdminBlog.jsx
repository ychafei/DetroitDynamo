    ...
    <div className="py-12">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between mb-8">
          <h1 className="font-oswald text-3xl font-bold tracking-tight text-foreground">BLOG POSTS</h1>
          <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
              <Button onClick={() => { setEditing({ ...empty, tags: [] }); setTagInput(''); }} className="bg-accent text-accent-foreground font-oswald tracking-wider uppercase text-xs hover:bg-accent/90">
                <Plus className="w-4 h-4 mr-2" /> New Post
              </Button>
            </DialogTrigger>
            <DialogContent className="max-w-3xl bg-card border-border max-h-[90vh] overflow-y-auto">
              <DialogHeader><DialogTitle className="font-oswald tracking-wider">{editing?.id ? 'EDIT POST' : 'NEW POST'}</DialogTitle></DialogHeader>
              {editing && (
                <div className="space-y-4 mt-4">
                  ...
                  <div>
                    <Label className="font-oswald tracking-wider uppercase text-xs">Slug</Label>
                  ...
                  <div>
                    <Label className="font-oswald tracking-wider uppercase text-xs">Author</Label>
                  ...
                  <div>
                    <Label className="font-oswald tracking-wider uppercase text-xs">Cover Image URL</Label>
                  ...
                  <div>
                    <Label className="font-oswald tracking-wider uppercase text-xs">Excerpt</Label>
                  ...
                  <div>
                    <Label className="font-oswald tracking-wider uppercase text-xs mb-1 block">Body</Label>
                    <ReactQuill
                      theme="snow"
                      value={editing.body || ''}
                  ...
                  <div>
                    <Label className="font-oswald tracking-wider uppercase text-xs">Tags</Label>
                  ...
                  <div>
                    <Label className="font-oswald tracking-wider uppercase text-xs">SEO Description</Label>
                  ...
                  <Button onClick={save} className="w-full bg-accent text-accent-foreground font-oswald tracking-wider uppercase hover:bg-accent/90">Save Post</Button>
                </div>
              )}
            </DialogContent>
          </Dialog>
            ...
            <div key={post.id} className="bg-card border border-border rounded-lg p-4 flex items-center justify-between">
              <div>
                <div className="flex items-center gap-2">
                  <p className="font-oswald tracking-wider text-foreground">{post.title}</p>
